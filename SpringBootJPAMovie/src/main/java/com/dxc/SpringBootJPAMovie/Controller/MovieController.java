package com.dxc.SpringBootJPAMovie.Controller;
...
import com.dxc.SpringBootJPAMovie.Service.MovieService;
...
public class MovieController 
{
	...
	// http://localhost:8567/movie/all
	@RequestMapping(value = "/all", method = RequestMethod.GET)
	public List<Movie> getAllMovie() {
		return this.movieService.getAllMovies();
	}

	// http://localhost:8567/movie/addMovie
	...
	// http://localhost:8567/movie/updateEmployee
	...
	// http://localhost:8567/movie/1
	@RequestMapping(value = "/{id}", method = RequestMethod.GET)
	public Optional<Movie> getSearchMovie(@PathVariable int id) {
		return this.movieService.getSearchMovieById(id);
	}
